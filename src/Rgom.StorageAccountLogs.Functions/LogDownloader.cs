...
namespace StorageEventFunctions
{
	class LogDownloader
	{
		...
		public static List<CloudBlob> DownloadStorageLogs(CloudStorageAccount storageAccount, string serviceName, DateTime startTimeOfSearch, DateTime endTimeOfSearch)
		{
